...
export default function SettingScreen() {
  ...
  return (
    ...
    <View style={styles.header}>
      {/* Bar Navigasi Atas */}
      <Animated.View entering={FadeInDown.delay(0)} style={styles.headerContainer}>
        ...
        <View style={styles.rightSection}>
          <TouchableOpacity onPress={() => router.push('/profile/finance')} style={styles.iconButton}>
            <Ionicons name="person-outline" size={24} color="#007aff" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => router.push('/profile/privacy')} style={styles.iconButton}>
